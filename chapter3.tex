...
Nodes online/offline state can change during the simulation the peers of a node have to get this information. \todo{change code: model it by offline/online notification from simulation environment}
