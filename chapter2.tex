...
In the last section we gave a brief overview of the key aspects of peer-to-peer systems and their envolvement over time. As any tool and technology, P2P systems have advantages and disadvantages and can be used for good or evil depending. Now we will discuss how the demand for privacy lead to a complex class of peer-to-peer networks, the darknets.

\subsection{Consequences of decentralisaton}
