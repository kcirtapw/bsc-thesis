...
\item The \emph{lost/sent ratio}, the ratio of the amount of lost or dropped messages to the amount of sent messages, is a metric for the quality and reliability of a network. It

\item A similar metric is the \emph{overhead}. It measures how much resources have to be used to transmit the actual information. It can be measured as the \emph{overhead messages ratio} or the overhead bandwith ratio.
